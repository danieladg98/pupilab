<nav id="navmain" class="navbar fixed-top navbar navbar-expand">
  <div class="col-1"></div>
    ...
    <a id="" class="col-1 white" href="empresa.php">A EMPRESA</a>
    <a id="" class="col-1 white" href="servicos.php">SERVIÇOS</a>
    <a id="" class="col-1 white" href="produtos.php">PRODUTOS</a>
    <a id="" class="col-1 white" href="contactos.php">CONTACTOS</a>
  <div class="col-1"></div>
</nav>
